                            ...
                            <>
                                ...
                                {role === 'patient' && (
                                    <div className="grid grid-cols-2 gap-2">
                                        <div>
                                            <label className="block text-xs font-bold text-slate-700 mb-1">Year of Birth</label>
                                            <input
                                                type="number"
                                                min="1900"
                                                ...
                                                className="w-full px-3 py-2.5 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-teal-500 focus:outline-none"
                                            />
                                        </div>
                                        <div>
                                            ...
                                            <select
                                                ...
                                                className="w-full px-3 py-2.5 border border-slate-200 bg-white rounded-xl text-sm focus:ring-2 focus:ring-teal-500 focus:outline-none"
                                            >
